...
@section('content')
    @php
        $defaultImg = $user->avatar == null ? asset('images/default-image.png') : $user->avatar;
    @endphp
                                ...
                                <div id="main-info" class="tab-pane fade in active">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Tên User" required value="{{ old('name',$user->name) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" placeholder="Email@gmail.com" required value="{{ old('email',$user->email) }}">
